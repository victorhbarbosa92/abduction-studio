...
# Trazer para frente e garantir foco
user32.SetForegroundWindow(found_hwnd)
time.sleep(1.0)

print("[TEST] 2. Abrindo Piano Roll...")
mouse_click(560, 16)
time.sleep(1.2)

# Clicar no botão '🚀 Riff Machine (Alt+R)' no SubToolBarFL do Piano Roll
print("[TEST] 3. Clicando no botao '🚀 Riff Machine (Alt+R)'...")
# Clica no botão Riff Machine na barra de ferramentas do Piano Roll
mouse_click(515, 120)
time.sleep(1.2)

print("[TEST] 4. Capturando screenshot do Riff Machine Modal...")
trigger_and_save("riff_machine_modal_fixed.png")
time.sleep(0.5)
