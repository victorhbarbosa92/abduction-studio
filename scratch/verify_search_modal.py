...
output_png = r"C:\Users\USUÁRIO\.gemini\antigravity-ide\brain\99c43430-c66d-4980-bd72-557c18180e32\dj_search_modal_verified.png"
...
print("Starting app with --test-search-modal...")
proc = subprocess.Popen([exe_path, "--test-search-modal"], cwd=exe_dir)
time.sleep(4.0)
...
if os.path.exists(bmp_file):
    ...
    print(f"Successfully saved search modal capture to {output_png} (Size: {im.size})")
else:
