...
print("[TEST] 2. Abrindo Piano Roll (F7)...")
# Botão Piano no Cockpit top bar (x=560, y=16)
mouse_click(560, 16)
time.sleep(1.2)

# Clica no botão FIT NOTAS para posicionar
mouse_click(585, 90)
time.sleep(0.5)

print("[TEST] 3. Capturando screenshot do Piano Roll e Playlist com AI Inpainting...")
