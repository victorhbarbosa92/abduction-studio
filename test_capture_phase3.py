...
def main():
    ...
    if not os.path.exists(exe_path):
        exe_path = "AbductionStudioV2.exe"

    print(f"[TEST] Iniciando {exe_path} com --test-usb-export...")
    proc = subprocess.Popen([exe_path, "--test-usb-export"], cwd=".")
    time.sleep(4.5)

    print("[TEST] Capturando screenshot do Abduction DJ Studio Phase 3 com Gaveta USB...")
    shot = trigger_and_save("dj_phase3_usb_verified.png")
    ...
    if shot and os.path.exists(shot):
        ...
        print("[TEST] FALHA ao capturar screenshot!")
