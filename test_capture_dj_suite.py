...
def main():
    ...
    print("[TEST] Iniciando AbductionStudioV2.exe com --open-dj...")
    proc = subprocess.Popen(["AbductionStudioV2.exe", "--open-dj"], cwd=".")
    time.sleep(4.0)

    print("[TEST] Capturando screenshot do Abduction DJ Studio Fullscreen...")
    shot = trigger_and_save("abduction_dj_studio_fullscreen.png")
