...
def main():
    ...
    print(f"[TEST] Iniciando {exe_path} com --test-dj-crates...")
    proc = subprocess.Popen([exe_path, "--test-dj-crates"], cwd=".")
    time.sleep(4.5)

    print("[TEST] Capturando screenshot do DJ Crates & Pastas por Vertentes (Progressive Psytrance)...")
    ...
    if shot and os.path.exists(shot):
        print(f"[TEST] SUCESSO ABSOLUTO: {shot}")
        sys.exit(0)
    else:
