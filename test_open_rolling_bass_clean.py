...
if found_hwnd:
    user32.ShowWindow(found_hwnd, 3)
    user32.SetForegroundWindow(found_hwnd)
    time.sleep(0.8)
    
    # Clicar no botão 'Rolling Bass' verde no meio da barra de ferramentas do Piano Roll
    # Na imagem 21, o botão 'Rolling Bass' está aproximadamente em x=745, y=302
    print("[TEST] Clicando no botao 'Rolling Bass' no Piano Roll...")
    mouse_click(745, 302)
    time.sleep(1.2)
    
    shot = trigger_and_save("22_kuro_psy_rolling_bass_full_mockup_match.png")
